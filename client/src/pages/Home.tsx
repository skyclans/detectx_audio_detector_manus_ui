...
// Usage is incremented server-side in /verify-audio (single source of truth)
  ...
  return (
    <ForensicLayout>
      <SEO
        title="Verify Audio — Detect AI-Generated Music"
        description="Upload a song to verify if it was AI-generated by Suno, Udio, or other AI music tools. Free, no signup needed."
        path="/verify-audio/"
      />
